...
dependencies {
    ...
    testImplementation("com.graphql-java-kickstart:graphiql-spring-boot-starter:5.10.0") { because("Embedded Graphql IDE") }
...
val jarName = "ganesh-product-service"
...
docker {
    ...
    name = "ganesh/product-service:latest"
